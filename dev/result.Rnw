...
def make_period_table(stats_dict, caption, label):
    lines = []
    lines.append(r'\begin{table}[H]')
    lines.append(r'\centering')
...
print(make_period_table(stats_min, 'Minimum (worst case)', 'tab:period_min'))
print()
print(make_period_table(stats_max, 'Maximum (best case)', 'tab:period_max'))
print()
print(make_period_table(stats_median, 'Median', 'tab:period_median'))
print()
print(make_period_table(stats_mean, 'Mean', 'tab:period_mean'))
@
