...
_LAZY_IMPORTS = {
    ...
    "_tschema_dict_expand_bbgfc": (".tickers", "_tschema_dict_expand_bbgfc"),
    "_tschema_dict_expand_split": (".tickers", "_tschema_dict_expand_split"),
    "filter_tickers": (".tickers", "filter_tickers"),
    "get_prices": (".tickers", "get_prices"),
    "actions": (".tickers", "actions"),
    "get_straddle_actions": (".tickers", "get_straddle_actions"),
    "get_straddle_valuation": (".tickers", "get_straddle_valuation"),
    "load_all_prices": (".tickers", "load_all_prices"),
    "set_prices_dict": (".tickers", "set_prices_dict"),
    "get_price": (".tickers", "get_price"),
    "clear_prices_dict": (".tickers", "clear_prices_dict"),
    "clear_prices_connection_cache": (".tickers", "clear_prices_connection_cache"),
    "clear_override_cache": (".tickers", "clear_override_cache"),
    "prices_last": (".tickers", "prices_last"),
    "prices_query": (".tickers", "prices_query"),
    "get_tickers_ym": (".tickers", "get_tickers_ym"),
